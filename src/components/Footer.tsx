                    ...
                    <div className="md:col-span-4">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:contact@equitechlab.com" className="text-slate-700 hover:text-blue-900 text-sm transition-colors">contact@equitechlab.com</a>
                            </li>
                            <li className="flex items-center gap-3">
                                <a href="https://www.linkedin.com/company/equitechlab/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
